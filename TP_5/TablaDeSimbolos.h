...
void agregarFuncionDefinidaATablaSinRepetir(TS *, Funciones, Error **, Variables **);
void agregarFuncionDeclaradaATablaSinRepetir(TS *, Funciones, Error **, Variables **);
...
void matcheanTiposDeParametros(Funciones *, Funciones *);
void matcheanCantidadDeParametros(Funciones *, Funciones *);
void matcheanTiposDeFunciones(Funciones *, Funciones *);
...
int existeVariableTipo(Variables *, char *);
int variablesOperablesEntreSi(Variables *);
